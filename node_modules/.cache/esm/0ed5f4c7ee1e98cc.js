let _SingleListNode;_ee1‍.x([["default",()=>SinglyLinkedList]]);_ee1‍.w("./SingleListNode",[["default",["_SingleListNode"],function(v){_SingleListNode=v}]]);
    ...
    printList = (params) => {
        ...
        for(let i = 0;i<this.size;i++){
            ...
            _ee1‍.g.console.log("CURRENT NODE",node.value)
            console.log("--------------------------------")
            node = node.next
        }
    }
